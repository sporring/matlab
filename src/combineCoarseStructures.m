function L = combineCoarseStructures(I,J,K,sz,VERBOSE)
...
if VERBOSE
    waitbarTxt(0,4,"combineCoarseStructures: Masking");
end
...
if VERBOSE
    waitbarTxt(1,4,"combineCoarseStructures: Dilating");
end
if sz > 0
    I = imdilate(I,se);
    J = imdilate(J,se);
...
if VERBOSE
    waitbarTxt(2,4,"combineCoarseStructures: Combining");
end
L = I & J | I & K | J & K;
if VERBOSE
    waitbarTxt(3,4,"combineCoarseStructures: Filling holes");
end
if sz > 0
    L = imfill(L,"holes"); % very slow, probably imreconstruct
end
if VERBOSE
    waitbarTxt(4,4,"combineCoarseStructures: Eroding");
end
if sz > 0
    L = imerode(L,se);
end
